...
def traite_case(i, j):
    """Fait une étape de l'automate pour la case de coordonnées (i, j) en retournant la nouvelle valeur de la case du tableau"""
    pass

    
def  etape():
    """Fait une étape du jeu de la vie en modifiant la variable gloable tableau"""
